...
public class Signup extends AppCompatActivity {
    ...
    EditText email_et, name_et, password_et, confirmPassword_et;
    Button btn_signup;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        confirmPassword_et = findViewById(R.id.et_confirmPassword);
        ...
        btn_signup.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (TextUtils.isEmpty(password)){
                    Toast.makeText(Signup.this, "Please Provide Password ", Toast.LENGTH_SHORT).show();
                }
                if (TextUtils.isEmpty(confirmPassword)){
                    Toast.makeText(Signup.this, "Please Provide Confirm Password ", Toast.LENGTH_SHORT).show();
                }
